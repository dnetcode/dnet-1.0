...
static struct FeatureDesc {
  ...
  F_S(HIDDEN_HOST, FEAT_CASE, "user.devnet.pw", 0),
  ...
  F_S(HIS_SERVERNAME, 0, "*.devnet.pw", feature_notify_servername),
  F_S(HIS_SERVERINFO, 0, "Dev IRC Network", feature_notify_serverinfo),
  F_S(HIS_URLSERVERS, 0, "https://github.com/dnetcode/", 0),

  /* Misc. random stuff */
  F_S(NETWORK, 0, "DevNET", set_isupport_network),
  F_S(URL_CLIENTS, 0, "http://www.ircreviews.org/clients/", 0),
  F_S(URLREG, 0, "https://github.com/dnetcode/", 0),
  ...
  F_S(HIDDEN_OPERHOST, FEAT_CASE, "staff.devnet.pw", 0),
  F_I(HOST_HIDING_STYLE, 0, 2, 0),
  F_S(HOST_HIDING_PREFIX, 0, "DevNET", 0),
